    ...
    <a href="#top" className="logo" aria-label="Qurban Alfatihah">
      <span className="mark">
        <svg viewBox="0 0 32 32" fill="none">
          {/* crescent + sprout mark */}
          <path d="M22 6a10 10 0 1 0 0 20 8 8 0 1 1 0-20z" fill="#fff"/>
          <path d="M24 9c-.4 2.4.6 4.2 2.4 5-2 .8-3.4 2.4-3.4 4.6 0-2.2-1.4-3.8-3.4-4.6 1.8-.8 2.8-2.6 2.4-5z" fill="#FF8C00"/>
        </svg>
      </span>
